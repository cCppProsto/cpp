...
{
  mvCircles.push_back(std::make_unique<circle>(0, 768));
  /*
  mvCircles.push_back(std::make_unique<circle>(200, 0));
  mvCircles[1].get()->set_speed(1);
  mvCircles[1].get()->set_gravity(0.1);

  mvCircles.push_back(std::make_unique<circle>(300, 0));
  mvCircles[2].get()->set_speed(2);
  mvCircles[2].get()->set_gravity(0.4);

  mvCircles.push_back(std::make_unique<circle>(400, 0));
  mvCircles[3].get()->set_speed(0);
  mvCircles[3].get()->set_gravity(0.3);
  */
}
//------------------------------------------------------------------------------
